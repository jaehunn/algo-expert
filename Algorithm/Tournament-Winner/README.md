There's an algorithms tournament talking place in which teams of programmers compete against each other to solve algorithmic problems as fast as possible.
